...
class Api:
    ...
    def __init__(self, format: str, api_key: str, balance: int):
        ...
        self.cities_request_url = 'http://htmlweb.ru/geo/api.php?area={region_num}&json&api_key={api_key}&perpage=300'
    ...
    def append_regions_results_list(self, path: str, data):
        """
